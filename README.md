...
Бот использует поисковый API (Google CSE или Serper) для поиска внешних источников,
после чего GPT структурирует только найденные факты. Для работы нужно заполнить:
...
Опционально:
- `SEARCH_PROVIDER` (по умолчанию `google`, можно `serper`)
